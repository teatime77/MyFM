...
Module Module1
    ...
    Sub Main()
        ...
        'Dim project_file_list As String() = {"sample\Basic\App6\App6.xml", "sample\Basic\App4\App4.xml", "sample\Basic\App5\App5.xml"}
        Dim project_file_list As String() = {"sample\Basic\App6\App6.xml"}
